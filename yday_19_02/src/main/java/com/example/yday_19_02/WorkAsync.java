...
public class WorkAsync extends AsyncTask<Void,Void,List<Music>> {
    ...
    protected List<Music> doInBackground(Void... params) {
        ...
        String[] projection=new String[]{MediaStore.Audio.Media.TITLE,MediaStore.Audio.Media.ARTIST,MediaStore.Audio.Media.DATA};
        ...
        if (cursor.moveToFirst()){
            for (;!cursor.isAfterLast();cursor.moveToNext()){
                ...
                Music music=new Music(musicName,singerName,dataPath);
                temp.add(music);
            }
        }
        cursor.close();
